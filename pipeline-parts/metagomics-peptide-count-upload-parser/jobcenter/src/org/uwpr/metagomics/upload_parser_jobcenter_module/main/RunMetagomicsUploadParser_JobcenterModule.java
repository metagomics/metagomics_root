...
import org.uwpr.metagomics.upload_parser_jobcenter_module.config.GetConfigFromFileServiceImpl;

/**
 * main class executed by  Client
 *
 */
public class RunMetagomicsUploadParser_JobcenterModule implements ModuleInterfaceClientMainInterface {
...
//				Integer jobRequiredExecutionThreads = moduleInterfaceRequest.getJobRequiredExecutionThreads();
			...
			boolean runResult = 
					RunMetagomicsUploadParser_Main
