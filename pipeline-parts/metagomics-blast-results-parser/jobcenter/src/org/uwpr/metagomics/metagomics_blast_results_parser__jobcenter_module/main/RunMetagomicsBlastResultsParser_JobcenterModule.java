...
import org.uwpr.metagomics.metagomics_blast_results_parser__jobcenter_module.config.GetConfigFromFileServiceImpl;

/**
 * main class executed by  Client
 *
 */
public class RunMetagomicsBlastResultsParser_JobcenterModule implements ModuleInterfaceClientMainInterface {
...
//				Integer jobRequiredExecutionThreads = moduleInterfaceRequest.getJobRequiredExecutionThreads();
			...
			boolean runResult = 
					RunMetagomicsBlastResultsParser_Main
