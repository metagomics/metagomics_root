package org.uwpr.metagomics.fasta_importer_executor_jobcenter_module.config;
...
public class GetConfigFromFileServiceImpl {
    ...
    private static final String CONFIG_FILE_NAME = "runMetagomicsFastaParser.properties";
