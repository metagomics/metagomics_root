 ...
 *
 */
public class RunMetagomicsRunBlast_JobcenterModule implements ModuleInterfaceClientMainInterface {
	...
	private static final String JOB_PARAM_BLAST_DATABASE = "blast_database";

	private static final String MODULE_LABEL = "Metagomics_RunBlast_Module";
...
//	Job Manager lifecycle methods
	...
	public void processRequest( ModuleInterfaceRequest moduleInterfaceRequest, ModuleInterfaceResponse moduleInterfaceResponse, ModuleInterfaceJobProgress moduleInterfaceJobProgress, ModuleInterfaceClientServices moduleInterfaceClientServices  ) throws Throwable {
		...
		int threads = moduleInterfaceRequest.getNumberOfThreadsForRunningJob();
...
//		List<String> responseMessages = new ArrayList<>();
		...
		String databaseToBlast = jobParameters.get( JOB_PARAM_BLAST_DATABASE );
		...
		try {
			...
			if ( StringUtils.isEmpty( databaseToBlast ) ) {
				String msg = methodName + ": job parameter " + JOB_PARAM_BLAST_DATABASE + " cannot be empty or null.";
				log.error( msg );
				throw new Exception( msg );
			}
...
//			int overallMessageType = RunMessageTypesConstants.RUN_MESSAGE_TYPE_MSG;
			...
			RunMetagomicsRunBlast_Main
			.getInstance().runCommandForParams( 
					runId, 
					databaseToBlast,
					threads,
					jobcenterRequestId );
...
//			msg = "Successful completion of uploadId: " + uploadId;
...
//			responseMessages.add( msg );
			...
			String msg = "Failed completion of Request Id: " + jobcenterRequestId;

			moduleInterfaceResponse.addRunMessage( RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR , msg );
//			responseMessages.add( msg );

			moduleInterfaceResponse.addRunMessage( RunMessageTypesConstants.RUN_MESSAGE_TYPE_ERROR , ex.toString() );
